main_map = {
    ...
    'DRUM-LINE': {
            ...
            'DESCRIPTION': "It's the drum line locker rooms! They are what really hold the band into their top level."
                           ...
                           "junior/senior player, you best leave now... ",
    ...
    'PERCUSSION': {
            ...
            'DESCRIPTION': "This isn't a room necessarily but more of a section of the room. There are murambas and drm"
                           ...
                           "and unoccupied... ",
            'AV_DIR': "Go WEST for the Wood-Wind_Lockers and NORTH_EAST to enter into the Drum-Line_Lockers. Go NORTH "
                      "to enter the Main_Band_Room.",
            'PATHS': {
                'WEST': 'WOOD-WIND',
